...
Enone <- enONE(Enone, 
               ...
               eval.pam.k = 2:8, eval.pc.n = 3, 
               n.pos.eval = 1200, n.neg.eval = 500,
               return.norm = TRUE
               )
```
